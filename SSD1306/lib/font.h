...
Hmm. it looks like it's on it's side. Check another

{ 0x27, 0x45, 0x45, 0x45, 0x39 }, // 35 5


00100111  //  so, lsb is top row, <<1 is next row, etc etc fuck en hell. 
01000101  // 
01000101  // 
01000101  // 
00111001  // 
...
Use as an ASCII bitmap.
=======================

Rough notes

We'll need to flip it 90o
so, lsb is top row, <<1 is next row, etc etc
...
nb: j*CHARS_COLS_LENGTH; 

Since we are hardcoding this font to this project. x5 is fine. 

ps: <<3 is _better_ the font is a bit wider; I prefer it. so bitshift 3 (x8). :-) 
